...
public class MyOutput {
    public static void main(String args[]) throws CloneNotSupportedException{
        ...
        // If you want to check IllegalArgumentExceptions being thrown, you can instantiate edu.ucalgary.oop.RobotDataLine, Movement, and Sensor. Bad data lines should be skipped by RobotDataRecord.
